...
public class MagneticCoilParticle extends SpriteBillboardParticle {
	final SpriteProvider spriteProvider;

	MagneticCoilParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
	...
	public static class Factory implements ParticleFactory<DefaultParticleType> {
		...
		public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
			return new MagneticCoilParticle(clientWorld, d, e, f, g, h, i, this.spriteProvider);
		}
	}
}
